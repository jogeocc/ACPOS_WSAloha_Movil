...
{
    public class QTYPRICEServicio : ServicioBaseALH<QTYPRICE>, IQTYPRICE
    {
        public QTYPRICEServicio(AplicacionBdContextoALH contexto) : base(contexto)
        {
        }

        public override List<QTYPRICE> GetAll()
        {
            List<QTYPRICE> List = new List<QTYPRICE>();
            ...
            {
                QTYPRICE priceItem = new QTYPRICE();
